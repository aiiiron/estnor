...
<?php $swatches = ['#1f4d3a', '#13342a', '#2c5a45']; foreach ($h['products'] as $i => $p): ?>
      <a class="house-card" href="<?= e($p['href']) ?>">
        <div class="art">
...
<?php endforeach; ?>
    ...
    <div class="wrap btn-row">
      <a class="btn btn-ghost" href="<?= e($h['renovation_href']) ?>"><?= e($h['renovation_label']) ?> →</a>
    </div>
  </section>
...
<?php endforeach; ?>
      ...
      <div class="btn-row"><a class="btn btn-ghost" href="<?= e($h['see_all_href']) ?>"><?= e($T['common']['see_all']) ?></a></div>
    </div>
  </section>
