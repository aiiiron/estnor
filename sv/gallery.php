...
$PAGE_DESC  = 'Bilder från EstNors tillverkning, hus under uppförande och färdiga hus.';
require __DIR__ . '/../partials/head.php';
?>

  <section class="section page-hero">
    <div class="wrap">
      <div class="breadcrumb"><a href="index.php">Startsida</a> / <span>Galleri</span></div>
      <span class="eyebrow">Från fabrik till byggplats</span>
      <h1 class="hero-title">Tillverkning, hus under uppförande och färdiga hus</h1>
      <p class="lead">En inblick i produktionen i Kiili, hus under uppförande och färdigställda hus.</p>
    </div>
  </section>
    ...
    <div class="wrap">
      <div class="gallery-grid">
        <div class="tile tall">
          ...
          <div class="cap">Tillverkning</div>
        </div>
        <div class="tile">
        ...
        <div class="tile">
          ...
          <div class="cap">Under uppförande</div>
        </div>
        <div class="tile">
  ...
  <section class="section section--dark">
    <div class="wrap cta-band">
      <div>
        ...
        <p>Se våra projekt eller kontakta oss för att boka ett fabriksbesök.</p>
      </div>
      <a class="btn btn-primary" href="projects.php">Se projekt</a>
    </div>
  </section>
