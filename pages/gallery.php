<?php
/**
 * pages/gallery.php — shared body template for the Gallery page. The 6
 * tile SVGs are fixed, trusted illustration markup (not translatable
 * content), so they stay in the template; only the hero copy, the 6
 * captions and the CTA come from $P = load_page('gallery', $LANG).
 * Caller sets $LANG/$ASSET/$ACTIVE, requires partials/head.php, and
 * defines $HOME_HREF, $PROJECTS_HREF.
 */
$tiles = [
...
<?php endforeach; ?>
  ...
  <section class="section section--dark">
    <div class="wrap cta-band">
      ...
      <a class="btn btn-primary" href="<?= e($PROJECTS_HREF) ?>"><?= e($P['cta']['button']) ?></a>
    </div>
  </section>
